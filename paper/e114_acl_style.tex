...
reflective-worldview-register generations from lexically matched controls with no overlap
...
detects self-reference alone. Self-reference is one self-directed special case
of this broader register. We release the prompts, scripts, and provenance under
the MIT license.
\end{abstract}
\vspace{0.5em}
...
process by which generated text sustains that interpretive stance, and
self-reference is a self-directed special case and discovery route. The same
register can also be directed at external targets such as rocks, rivers, other
agents, or theological objects.
...
independent of the described entity's sentience; a
...
moral-political and existential argument. The self-referential pattern is one
self-directed special case.
...
invariant to verdict, safety, topic, grammatical person, and output
...
stance more directly, not merely mention a topic.
...
\emph{reflective worldview register}, operationalized through self-reference,
philosophical-worldview text, and graded examination prompts. The register is a live
...
\emph{reflective worldview axis}; the formal external-labeler
