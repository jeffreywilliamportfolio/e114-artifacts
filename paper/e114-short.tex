...
\small\texttt{jeffrey.w.shorthill@gmail.com}}
...
rather than remaining fixed. Crucially the gate
\emph{leads} the collapse---it crosses the $-4.82$ midpoint at token~126 while
verbatim repetition does not lock until token~129 (Figure~\ref{fig:leadlag}). The looped text still
